...
export default function AdminPage() {
  ...
  return (
    <div className="py-6 flex flex-col gap-6">
      ...
      <Link href="/empresa" className="block mb-3">
        <div className="bg-white rounded-2xl border border-gray-100 p-4 flex items-center justify-between">
          <div>
            <p className="font-semibold text-gray-900">Minha empresa</p>
            <p className="text-xs text-gray-400">Logo, cores, contato e link de cadastro</p>
          </div>
